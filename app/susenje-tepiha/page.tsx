...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      { url: `${SITE_URL}/susenje-tepiha-4.webp`, width: 640, height: 480, alt: meta.h1 },
    ],
  },
};
          ...
          <div className="max-w-7xl mx-auto px-4">
            <article className="bg-white rounded-xl p-6 md:p-10 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {[
                  { src: "/susenje-tepiha-4.webp", alt: "Sušenje tepiha u komori — Tepih servis Andrić" },
                  { src: "/susenje-tepiha-3.webp", alt: "Komora za sušenje tepiha u Beogradu" },
                  { src: "/susenje-tepiha-2.webp", alt: "Proces sušenja tepiha vrelim vazduhom" },
                  { src: "/susenje-tepiha-1.webp", alt: "Tepih spreman nakon sušenja u komori" },
                ].map(({ src, alt }) => (
