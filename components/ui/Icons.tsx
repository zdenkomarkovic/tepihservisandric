...
export function PawIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M12 17c-3.87 1.5-6 .5-6-2 0-1.5 1-3 3-4l3-1.5 3 1.5c2 1 3 2.5 3 4 0 2.5-2.13 3.5-6 2z" />
    </svg>
  );
}
...
export function SofaIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M2 11a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-4z" />
      <path d="M6 17v2" />
      <path d="M18 17v2" />
    </svg>
  );
...
export function NeedleIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M12 10c0 0-6 4-6 8a6 6 0 0 0 12 0c0-4-6-8-6-8z" />
    </svg>
  );
}
