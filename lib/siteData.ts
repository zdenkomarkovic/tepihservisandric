...
export const LOCATION_META: Record<string, PageMeta> = {
  autokomanda: {
    title: "Pranje Tepiha Autokomanda, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Autokomanda (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    pageH1: "Pranje Tepiha Autokomanda — Tepih Servis Andrić",
    h1: "Tepih Servis, Pranje Tepiha Autokomanda",
  },
  banjica: {
    title: "Pranje Tepiha Banjica, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Banjica (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Banjica",
    pageH1: "Pranje Tepiha Banjica — Tepih Servis Andrić",
  },
  "banovo-brdo": {
    title: "Pranje Tepiha Banovo Brdo, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Banovo Brdo (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Banovo Brdo",
    pageH1: "Pranje Tepiha Banovo Brdo — Tepih Servis Andrić",
  },
  "bezanijska-kosa": {
    title: "Pranje Tepiha Bežanijska Kosa | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Bežanijska Kosa (opština Novi Beograd) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  bogoslovija: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Bogoslovija, u centru Beograda blizu Slavije — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha i nameštaja.",
    h1: "Tepih Servis, Pranje Tepiha Bogoslovija",
    pageH1: "Pranje Tepiha Bogoslovija — Tepih Servis Andrić",
  },
  "brace-jerkovic": {
    title: "Pranje Tepiha Braće Jerković, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Braće Jerković (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Braće Jerković",
    pageH1: "Pranje Tepiha Braće Jerković — Tepih Servis Andrić",
  },
  cerak: {
    title: "Pranje Tepiha Cerak, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Cerak (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Cerak",
    pageH1: "Pranje Tepiha Cerak — Tepih Servis Andrić",
  },
  cubura: {
    title: "Pranje Tepiha Čubura, Vračar | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Čubura (opština Vračar) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "cukaricka-padina": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Čukarička Padina (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Čukarička Padina",
    pageH1: "Pranje Tepiha Čukarička Padina — Tepih Servis Andrić",
  },
  dedinje: {
    title: "Pranje Tepiha Dedinje, Savski Venac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Dedinje (opština Savski venac) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Dedinje",
    pageH1: "Pranje Tepiha Dedinje — Tepih Servis Andrić",
  },
  djeram: {
    title: "Pranje Tepiha Đeram, Zvezdara | Tepih Servis Andrić",
    pageH1: "Pranje Tepiha Đeram — Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Đeram (opština Zvezdara) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Đeram",
  },
  dorcol: {
    title: "Pranje Tepiha Dorćol, Stari Grad | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Dorćol (opština Stari grad) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Dorćol",
    pageH1: "Pranje Tepiha Dorćol — Tepih Servis Andrić",
  },
  "golf-naselje": {
    title: "Pranje Tepiha Golf Naselje, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Golf Naselje (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Golf Naselje",
    pageH1: "Pranje Tepiha Golf Naselje — Tepih Servis Andrić",
  },
  jajinci: {
    title: "Pranje Tepiha Jajinci, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Jajinci (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Jajinci",
    pageH1: "Pranje Tepiha Jajinci — Tepih Servis Andrić",
  },
  kaludjerica: {
    title: "Pranje Tepiha Kaluđerica, Grocka | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Kaluđerica (opština Grocka) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Kaluđerica",
    pageH1: "Pranje Tepiha Kaluđerica — Tepih Servis Andrić",
  },
  "kanarevo-brdo": {
    title: "Pranje Tepiha Kanarevo Brdo, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Kanarevo Brdo (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Kanarevo Brdo",
    pageH1: "Pranje Tepiha Kanarevo Brdo — Tepih Servis Andrić",
  },
  karaburma: {
    title: "Pranje Tepiha Karaburma, Palilula | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Karaburma (opština Palilula) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Karaburma",
    pageH1: "Pranje Tepiha Karaburma — Tepih Servis Andrić",
  },
  konjarnik: {
    title: "Pranje Tepiha Konjarnik, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Konjarnik (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Konjarnik",
    pageH1: "Pranje Tepiha Konjarnik — Tepih Servis Andrić",
  },
  kumodraz: {
    title: "Pranje Tepiha Kumodraž, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Kumodraž (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Kumodraž",
    pageH1: "Pranje Tepiha Kumodraž — Tepih Servis Andrić",
  },
  "lekino-brdo": {
    title: "Pranje Tepiha Lekino Brdo, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Lekino Brdo (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    pageH1: "Pranje Tepiha Lekino Brdo — Tepih Servis Andrić",
    h1: "Tepih Servis, Pranje Tepiha Lekino Brdo",
  },
  "mali-mokri-lug": {
    title: "Pranje Tepiha Mali Mokri Lug, Zvezdara | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Mali Mokri Lug (opština Zvezdara) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Mali Mokri Lug",
    pageH1: "Pranje Tepiha Mali Mokri Lug — Tepih Servis Andrić",
  },
  medakovic: {
    title: "Pranje Tepiha Medaković, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Medaković (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Medaković",
    pageH1: "Pranje Tepiha Medaković — Tepih Servis Andrić",
  },
  miljakovac: {
    title: "Pranje Tepiha Miljakovac, Rakovica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Miljakovac (opština Rakovica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Miljakovac",
    pageH1: "Pranje Tepiha Miljakovac — Tepih Servis Andrić",
  },
  mirijevo: {
    title: "Pranje Tepiha Mirijevo, Zvezdara | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Mirijevo (opština Zvezdara) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Mirijevo",
    pageH1: "Pranje Tepiha Mirijevo — Tepih Servis Andrić",
  },
  "mitrovo-brdo": {
    title: "Pranje Tepiha Mitrovo Brdo, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Mitrovo Brdo (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "novi-beograd": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Novi Beograd — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  palilula: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Palilula (Centar), opština Palilula — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  rakovica: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Rakovica — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "savski-venac": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Savski Venac — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Savski Venac",
    pageH1: "Pranje Tepiha Savski Venac — Tepih Servis Andrić",
  },
  senjak: {
    title: "Pranje Tepiha Senjak, Savski Venac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Senjak (opština Savski venac) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "slavujev-venac": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Slavujev Venac, u centru Beograda — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha i nameštaja.",
  ...
  "stari-grad": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Stari Grad — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "stepa-stepanovic": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Stepa Stepanović (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "uciteljsko-naselje": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Učiteljsko Naselje (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "veliki-mokri-lug": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Veliki Mokri Lug (opština Zvezdara) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Veliki Mokri Lug",
    pageH1: "Pranje Tepiha Veliki Mokri Lug — Tepih Servis Andrić",
  },
  "vojvode-stepe": {
    title: "Pranje Tepiha Vojvode Stepe, Voždovac | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha na Vojvode Stepe (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  "vojvode-vlahovica": {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha na Vojvode Vlahovića (opština Voždovac) — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  vozdovac: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Voždovac — besplatno preuzimanje i dostava, bez ograničenja u kvadraturi. Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  vracar: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Vračar — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Vračar",
    pageH1: "Pranje Tepiha Vračar — Tepih Servis Andrić",
  },
  "vukov-spomenik": {
    title: "Pranje Tepiha Vukov Spomenik, Zvezdara | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Vukov Spomenik (opština Zvezdara) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Vukov spomenik",
    pageH1: "Pranje Tepiha Vukov Spomenik — Tepih Servis Andrić",
  },
  zarkovo: {
    title: "Pranje Tepiha Žarkovo, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Žarkovo (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  zvezdara: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Zvezdara (Centar), opština Zvezdara — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
  ...
  zemun: {
    ...
    description: "Tepih Servis Andrić nudi pranje tepiha Zemun — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Zemun",
    pageH1: "Pranje Tepiha Zemun — Tepih Servis Andrić",
  },
  vidikovac: {
    title: "Pranje Tepiha Vidikovac, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Vidikovac (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
    h1: "Tepih Servis, Pranje Tepiha Vidikovac",
    pageH1: "Pranje Tepiha Vidikovac — Tepih Servis Andrić",
  },
  "filmski-grad": {
    title: "Pranje Tepiha Filmski Grad, Čukarica | Tepih Servis Andrić",
    description: "Tepih Servis Andrić nudi pranje tepiha Filmski Grad (opština Čukarica) — preuzimamo i dostavljamo uz minimalnu kvadraturu od 6m². Dubinsko čišćenje tepiha, nameštaja i dečijih kolica.",
...
export const LOCATION_IMAGE_ALTS: Record<string, string[]> = {
  "veliki-mokri-lug": [
    "Sušenje tepiha u komorama — Veliki Mokri Lug, Tepih Servis Andrić",
    "Profesionalno sušenje tepiha — Veliki Mokri Lug, Tepih Servis Andrić",
  ],
  kaludjerica: [
    "Čišćenje mebl nameštaja — Kaluđerica, Tepih Servis Andrić",
    "Pranje dečijih kolica — Kaluđerica, Tepih Servis Andrić",
  ],
  "mali-mokri-lug": ["Pranje tepiha Mali Mokri Lug — Tepih Servis Andrić"],
  medakovic: ["Pranje tepiha Medaković — Tepih Servis Andrić"],
  konjarnik: [
    "Pranje tepiha Konjarnik — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Konjarnik — Tepih Servis Andrić",
  ],
  "uciteljsko-naselje": [
    "Pranje tepiha Učiteljsko Naselje — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Učiteljsko Naselje — Tepih Servis Andrić",
  ],
  "lekino-brdo": [
    "Pranje tepiha Lekino Brdo — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Lekino Brdo — Tepih Servis Andrić",
  ],
  autokomanda: [
    "Pranje tepiha Autokomanda — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Autokomanda — Tepih Servis Andrić",
  ],
  "vojvode-stepe": ["Pranje tepiha Vojvode Stepe — Tepih Servis Andrić"],
  "brace-jerkovic": [
    "Pranje tepiha Braće Jerković — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Braće Jerković — Tepih Servis Andrić",
  ],
  "vojvode-vlahovica": [
    "Pranje tepiha Vojvode Vlahovića — Tepih Servis Andrić",
    "Zaštita tepiha nakon pranja — Vojvode Vlahovića, Tepih Servis Andrić",
  ],
  "mitrovo-brdo": [
    "Pranje tepiha Mitrovo Brdo — Tepih Servis Andrić",
    "Transport tepiha Mitrovo Brdo — Tepih Servis Andrić",
  ],
  "stepa-stepanovic": [
    "Transport i dostava tepiha — Stepa Stepanović, Tepih Servis Andrić",
    "Pranje tepiha Stepa Stepanović — Tepih Servis Andrić",
  ],
  kumodraz: [
    "Pranje tepiha Kumodraž — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Kumodraž — Tepih Servis Andrić",
  ],
  jajinci: [
    "Pranje tepiha Jajinci — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Jajinci — Tepih Servis Andrić",
  ],
  banjica: [
    "Pranje tepiha Banjica — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Banjica — Tepih Servis Andrić",
  ],
  zvezdara: [
    "Pranje tepiha Zvezdara (Centar) — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Zvezdara (Centar) — Tepih Servis Andrić",
  ],
  mirijevo: ["Pranje tepiha Mirijevo — Tepih Servis Andrić"],
  karaburma: ["Transport i dostava tepiha — Karaburma, Tepih Servis Andrić"],
  palilula: ["Pranje tepiha Palilula (Centar) — Tepih Servis Andrić"],
  "slavujev-venac": [
    "Pranje tepiha Slavujev Venac — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Slavujev Venac — Tepih Servis Andrić",
  ],
  "vukov-spomenik": [
    "Pranje tepiha Vukov Spomenik — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Vukov Spomenik — Tepih Servis Andrić",
  ],
  djeram: [
    "Pranje tepiha Đeram — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Đeram — Tepih Servis Andrić",
  ],
  vracar: ["Pranje tepiha Vračar — Tepih Servis Andrić"],
  cubura: [
    "Pranje tepiha Čubura — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Čubura — Tepih Servis Andrić",
  ],
  bogoslovija: [
    "Pranje tepiha Bogoslovija — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Bogoslovija — Tepih Servis Andrić",
  ],
  dorcol: ["Pranje tepiha Dorćol — Tepih Servis Andrić"],
  "stari-grad": ["Pranje tepiha Stari Grad — Tepih Servis Andrić"],
  "novi-beograd": ["Pranje tepiha Novi Beograd — Tepih Servis Andrić"],
  "bezanijska-kosa": ["Mašinsko pranje tepiha — Bežanijska Kosa, Tepih Servis Andrić"],
  "cukaricka-padina": [
    "Pranje tepiha Čukarička Padina — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Čukarička Padina — Tepih Servis Andrić",
  ],
  senjak: [
    "Pravo vreme za pranje tepiha — Senjak, Tepih Servis Andrić",
    "Pranje tepiha Senjak — Tepih Servis Andrić",
  ],
  dedinje: ["Pranje tepiha Dedinje — Tepih Servis Andrić"],
  "savski-venac": ["Pranje tepiha Savski Venac — Tepih Servis Andrić"],
  "banovo-brdo": [
    "Pranje tepiha Banovo Brdo — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Banovo Brdo — Tepih Servis Andrić",
  ],
  "golf-naselje": ["Pranje tepiha Golf Naselje — Tepih Servis Andrić"],
  vozdovac: ["Profesionalno čišćenje tepiha — Voždovac, Tepih Servis Andrić"],
  zarkovo: ["Pranje tepiha Žarkovo — Tepih Servis Andrić"],
  cerak: [
    "Pranje tepiha Cerak — Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Cerak — Tepih Servis Andrić",
  ],
  rakovica: ["Pranje tepiha Rakovica — Tepih Servis Andrić"],
  miljakovac: ["Pranje tepiha Miljakovac — Tepih Servis Andrić"],
  "kanarevo-brdo": [
    "Pranje tepiha sa šest rotacionih četki — Kanarevo Brdo, Tepih Servis Andrić",
    "Dubinsko čišćenje tepiha Kanarevo Brdo — Tepih Servis Andrić",
  ],
};
